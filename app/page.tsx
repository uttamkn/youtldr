...
Please check the URL and try again with a different video.`;
  ...
  return (
    <ProtectedRoute>
      <div className="bg-gray-100 pt-16 dark:bg-[#1f1f1f] flex flex-col md:flex-row min-h-screen">
        <aside className="w-full md:w-80 lg:w-96 bg-white dark:bg-gray-800 p-4 hidden md:block overflow-y-auto">
          <h2 className="text-2xl font-bold mb-4 text-teal-600 dark:text-red-400">
            History
          </h2>
          <UserHistoryList />
        </aside>
        ...
        <main className="flex-grow p-4">
          <Card className="bg-transparent border-none w-full max-w-2xl mx-auto shadow-none text-card-foreground">
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-center w-full text-teal-400 dark:text-red-400 text-3xl font-bold">
                  YouTLDR
                </CardTitle>
                <Sheet>
