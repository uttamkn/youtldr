...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen pt-16 flex flex-col items-center justify-center bg-gradient-to-br from-white via-cyan-500 to-indigo-600 dark:from-gray-900 dark:via-gray-800 dark:to-black">
