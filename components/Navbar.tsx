...
export function Navbar() {
  ...
  return (
    <nav className="fixed w-screen top-0 z-50 flex items-center justify-between px-6 py-4 bg-transparent backdrop-blur-sm shadow-sm transition-colors duration-300">
